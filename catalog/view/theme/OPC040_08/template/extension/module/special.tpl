<div class="special-carousel products-list ttspecial">
...
<div class="special-items products-carousel row">
    <?php foreach ($products as $product) { ?>
      ...
      <div class="button-group">
        <button class="btn-cart" type="button" title="<?php echo $button_cart; ?>" onclick="cart.add('<?php echo $product['product_id']; ?>');"><i class="fa fa-shopping-cart"></i> 
...
// product Carousel
var ttspecialproducts = $(".common-home .ttspecial .special-items.products-carousel");
	ttspecialproducts.owlCarousel({
	items: 3,
    itemsDesktop : [1200,2],
